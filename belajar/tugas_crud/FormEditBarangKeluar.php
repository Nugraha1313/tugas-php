...
<?php 
    ...
    $id = $_REQUEST['id'];
    $data_edit = $obj->getBarangKeluar($id);
    $data_nip = $obj3->dataPegawai();
    // var_dump($data_edit['kode_transaksi'][0]);
    ?>
<h2 class="text-center mt-4">EDIT BARANG KELUAR</h2>
        ...
        <div class="col-8">
            <select id="nip_peminjam" name="nip_peminjam" class="custom-select" required="required">
                ...
                <?php 
                        ...
                        $sel = ($nip['nip'] == $data_edit['nip_peminjam']) ? 'selected' : '';
                    ?>
