...
<?php 
    ...
    $result = new BarangKeluar();
    $data = $result->dataBarangKeluar();
    ?>

<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h2 class="text-dark font-weight-bold">Data Barang Keluar</h2>
        </div>
        <div class=" card-body">
            <div class="table-responsive">
                <a id="tambah" href="index.php?hal=FormBarangKeluar" class="btn btn-dark mb-3">
            ...
            ?>
                        <tr>
                            ...
                            <td><?= $rs['jumlah']; ?></td>
                            <td><?= $rs['satuan']; ?></td>
                            <td><?= $rs['nip_peminjam']; ?></td>
                            <td><?= $rs['keterangan']; ?></td>
                            <td>
                                <form method="POST" action="controller/BarangKeluarController.php">
                                    <a href="index.php?hal=FormEditBarangKeluar&id=<?= $rs['id']; ?>"
