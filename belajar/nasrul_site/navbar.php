<nav id="navbar" class="nav-menu navbar">
    <ul>
        <li><a href="index2.php?hal=home" class="nav-link scrollto active"><i class="bx bx-home"></i>
                <span>Home</span></a></li>
        <li><a href="index2.php?hal=about" class="nav-link scrollto"><i class="bx bx-user"></i> <span>About</span></a>
        </li>
        <li><a href="index2.php?hal=study" class="nav-link scrollto"><i class="bx bx-file-blank"></i>
